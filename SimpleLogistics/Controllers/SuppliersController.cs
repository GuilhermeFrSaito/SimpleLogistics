...
namespace SimpleLogistics.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CPF_CNPJ,Phone,Email,Description")] Supplier supplier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,CPF_CNPJ,Phone,Email,Description")] Supplier supplier)
        {
            if (id != supplier.Id)
            {
                return NotFound();
