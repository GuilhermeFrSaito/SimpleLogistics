...
namespace SimpleLogistics.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Brand,Model,Description")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Brand,Model,Description")] Item item)
        {
            if (id != item.Id)
            {
                return NotFound();
