...
namespace SimpleLogistics.Controllers
{
    public class SectorsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Sector.Include(s => s.Storage);
        ...
        {
            ViewData["Id"] = new SelectList(_context.Storage, "Id", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,StorageId")] Sector sector)
        {
            ...
            ViewData["Id"] = new SelectList(_context.Storage, "Id", "Name", sector.Id);
            return View(sector);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,StorageId")] Sector sector)
        {
            if (id != sector.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.Sector'  is null.");
            }
            var sector = await _context.Sector.FindAsync(id);
            if (sector != null)
            {
